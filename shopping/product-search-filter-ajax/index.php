        ...
        <div class="row">
            ...
            <div class="col-md-3">                				
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(product_brand) FROM product_filter WHERE product_status = '1' ORDER BY product_id DESC";
				...
				<div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(product_ram) FROM product_filter WHERE product_status = '1' ORDER BY product_ram DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
				...
				<div class="list-group">
					...
					<?php
                    $query = "
                    SELECT DISTINCT(product_storage) FROM product_filter WHERE product_status = '1' ORDER BY product_storage DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
